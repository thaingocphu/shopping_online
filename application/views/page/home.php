							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="<?php echo base_url('./uploads/product/'. $product->image); ?>" alt="" width="100px" height="200px">
										<h2><?php echo number_format($product->price, 0, '.', ',') . 'VNĐ'?></h2>
										<p><?php echo $product->title?></p>
										<a href="<?php echo base_url('chi-tiet-san-pham/'. $product->id) ?>" class="btn btn-default add-to-cart"><i class="fa fa-eye"></i>Details</a>
