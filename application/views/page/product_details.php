					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									<span><?php echo number_format($product->price, 0 , '.', ',') . "VNĐ"?></span><br>
								...
								<p><b>On Stock:</b> <?php echo $product->quantity?></p>
								<p><b>Memory:</b> <?php echo $product->description?></p>
								<p><b>Brand:</b> <?php echo $product->btitle?></p>
								<p><b>Category:</b> <?php echo $product->ctitle?></p>
